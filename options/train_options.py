...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        # training parameters
        self.parser.add_argument('--n_epochs', type=int, default=15, help='# of iter at starting learning rate')
        self.parser.add_argument('--n_epochs_decay', type=int, default=10, help='# of iter to linearly decay learning rate to zero')
