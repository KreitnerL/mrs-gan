...
python /home/kreitnerl/mrs-gan/raytune.py --dataroot /home/kreitnerl/mrs-gan/datasets/new_horizon_syn_real --name REG-CycleGAN_syn_real --model cycleGAN_W_REG --gpu_ids 6,7 --TTUR --n_critic 5 --gan_mode wasserstein --save_epoch_freq 100 --quiet --roi 361,713 --n_layers_D 3 --display_freq 2500

# REG-CycleGAN_syn_ucsf
python /home/kreitnerl/mrs-gan/raytune.py --dataroot /home/kreitnerl/mrs-gan/datasets/new_horizon_syn_ucsf --name REG-CycleGAN_syn_ucsf --model cycleGAN_W_REG --gpu_ids 6,7 --TTUR --n_critic 5 --gan_mode wasserstein --save_epoch_freq 100 --quiet --roi 361,713 --n_layers_D 3 --display_freq 2500

# REG-CycleGAN_ucsf
python /home/kreitnerl/mrs-gan/raytune.py --dataroot /home/kreitnerl/mrs-gan/datasets/new_horizon_ucsf --name REG-CycleGAN_ucsf --model cycleGAN_W_REG --gpu_ids 6,7 --TTUR --n_critic 5 --gan_mode wasserstein --save_epoch_freq 100 --quiet --roi 361,713 --n_layers_D 3 --display_freq 2500
